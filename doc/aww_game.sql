...
(
    ...
    group_id    bigint(20) NOT NULL COMMENT 'aww_group表的id',
    name        varchar(128)   DEFAULT NULL COMMENT 'nft分组全称',
    ...
    PRIMARY KEY (`id`),
    KEY `gid_ry_sp` (`group_id`, `rarity`, `sell_price`),
...
(
    ...
    `aww_id`       bigint(20)   NOT NULL COMMENT 'aww_info表的id',
    `group_id`     bigint(20)     DEFAULT NULL COMMENT 'group表id',
